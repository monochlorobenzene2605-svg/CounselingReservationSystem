function openReserveModal(ev) {
    ...
    document.getElementById("modal-counselor").value =
        target.dataset.counselorName;
    document.getElementById("user-name").value = target.dataset.studentName;
    document.getElementById("modal-time").value = dateVal + " " + target.dataset.time;
